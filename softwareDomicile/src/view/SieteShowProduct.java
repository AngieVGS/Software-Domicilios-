...
public class SieteShowProduct extends JPanel{
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			panel.add(new SieteShowProduct(new AssignProductToOwner(new Product("sdfghjklñ", "sdfghjkl", 124, State.RECEIVED, new ImageIcon("src/image/Buttons/LetsDoItButton.png")), new Owner(01, "ya", "123"))));
		}
